        ...
        return this.each(function () {
            ...
            if (settings.halfCircle) {
                ...
                circleContainer
                    ...
                    .append(
                        $('<svg xmlns="http://www.w3.org/2000/svgs1" version="1.1" viewBox="0 0 194 186" class="circliful">' +
            ...
            if (settings.replacePercentageByText !== null) {
                text = text + settings.replacePercentageByText;
            }
            ...
            function drawCircles() {
                if (settings.percentages.length > 0) {
                    ...
                    circleContainer
                        .addClass('svg-container')
                        .append(
                            $('<svg xmlns="http://www.w3.org/2000/svgs2" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                                (typeof elements !== 'undefined' ? elements : '') +
                                circles +
                                icon +
                                '<text class="timer" text-anchor="middle" x="' + percentageX + '" y="' + percentageY + '" style="font-size: ' + settings.percentageTextSize + 'px; ' + additionalCss + ';' + settings.textAdditionalCss + '" fill="' + settings.fontColor + '">' +
                    ...
                    circleContainer
                        .addClass('svg-container')
                        .append(
                            $('<svg xmlns="http://www.w3.org/2000/svgs3" version="1.1" viewBox="0 0 194 186" class="circliful">' +
                                (typeof elements !== 'undefined' ? elements : '') +
            ...
            function showLegend() {
                ...
                for (index = 0; index < percentages.length; ++index) {
                    ...
                    lines += '<div align="center" ><span  style="background: ' + color + '"></span>' + title + ' - ' + percent + '%</div>';
                }

                circleContainer.append(
                    $('<div/>')
                        .append(lines)
                        //.attr('style', 'font-size: 12px; position:absolute;top:' + height / 3 + 'px;left:' + (width + 20) + 'px')
						 .attr('style', 'font-size: 8px;color:#666666;')
